...
<!--
        ...
        @media screen,print {
            ...
            * {
            ...
            /* *** CABECALHO *** */
            #instr_header {
                background: url('<?php echo wcboleto_assets_url(); ?>images/logo_empresa.png') no-repeat top left;
                padding-left: 186px;
                height: 65px;
            }
            #instr_header h1 {
        ...
        <div id="boleto">
            ...
            <table class="header" border=0 cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td width="150">
                            <img src="<?php echo wcboleto_assets_url(); ?>images/logobancoob.jpg">
                        </td>
                        <td width="50">
                ...
                <tbody>
                    ...
                    <tr class="campos">
                        ...
                        <td class="carteira">
                            ...
                            <?php echo isset($dadosboleto["variacao_carteira"]) ? $dadosboleto["variacao_carteira"] : '&nbsp;' ?>
                        </td>
