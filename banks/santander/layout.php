		...
		<table cellspacing="0" cellpadding="0" width="666" border="0">
			<tr>
				<td class="cp" width="150">
					<span class="campo"><img src="<?php echo wcboleto_parcelado_assets_url(); ?>images/logosantander.jpg" width="140" height="37" border="0"></span>
				</td>
				...
				<tr>
					...
					<td class="cp" valign="top" width="126" height="12">
						<span class="campo">
							...
							<img src="<?php echo wcboleto_parcelado_assets_url(); ?>images/b.png" width="10" height="1">
							<?php echo $tmp2; ?>
						</span>
					</td>
					<td class="cp" valign="top" width="7" height="12">
					...
					<td class="cp" valign="top" align="right" width="120" height="12">
						<span class="campo"><? $tmp = $dadosboleto["nosso_numero"];
