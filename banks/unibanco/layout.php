		...
		<table width="666" cellspacing="5" cellpadding="0" border="0" align="default">
			<tr>
				...
				<td class="ti" width="455">
					<?php echo $dadosboleto["identificacao"]; ?><?php echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?><br>
		...
		<table cellspacing="0" cellpadding="0" width="666" border="0">
			<tr>
				<td class="cp" width="150">
					<span class="campo"><img src="<?php echo wcboleto_parcelado_assets_url(); ?>images/logounibanco.jpg" width="150" height="40" border="0"></span>
				</td>
		...
		<table cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td class="ct" valign="top" width="7" height="13">
						<img height="13" src="<?php echo wcboleto_parcelado_assets_url(); ?>images/1.png" width="2" border="0">
					</td>
		...
		<table cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td class="ct" valign="top" width="163" height="13">
				...
				<tr>
					...
					<td class="cp" valign="top" width="163" height="12">
						<span class="campo"><?php echo $dadosboleto["numero_documento"]?></span>
					</td>
					<td class="cp" valign="top" width="7" height="12">
						<img height="12" src="<?php echo wcboleto_parcelado_assets_url(); ?>images/1.png" width="1" border="0">
				...
				<tr>
					...
					<td valign="top" width="163" height="1">
						<img height="1" src="<?php echo wcboleto_parcelado_assets_url(); ?>images/2.png" width="163" border="0">
					</td>
					<td valign="top" width="7" height="1">
						<img height="1" src="<?php echo wcboleto_parcelado_assets_url(); ?>images/2.png" width="7" border="0">
					</td>
		...
		<table cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td class="ct" valign="top" width="180" height="13">
						Cód. baixa &nbsp;&nbsp;&nbsp;<span class="cp">CVT - 07744-5</span>
					</td>
				</tr>
				<tr>
					<td valign="top" width="7" height="1">
