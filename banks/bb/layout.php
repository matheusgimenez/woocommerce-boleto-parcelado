...
<!--
	...
	<body>
		<div id="container">
			...
			</div><!-- id="instr_header2" -->
			<div id="">
				<!--
  Use no lugar do <div id="2"> caso queira imprimir sem o logotipo e instruções
  <div id="instructions">
 -->
			...
			<div id="boleto">
				...
				<table class="header" border="0" cellspacing="0" cellpadding="0">
					<tbody>
						<tr>
							<td width="150">
								<img src="<?php echo wcboleto_parcelado_assets_url(); ?>images/logobb.jpg">
							</td>
							<td width="50">
